...
#Datatypes in this dataset are character and integer.
...
setdiff(colnames(math_por), join_cols)
free_cols
...
alc %>% group_by(sex, high_use) %>% summarise(count = n(), mean(G3))
...
g1 <- ggplot(alc, aes(x = high_use, y = G3, col = sex)) + geom_boxplot()
g1
# define the plot as a boxplot and draw it
g1 + geom_boxplot() + ylab("grade")
g1
# initialize a plot of high_use and absences
g1 <- ggplot(alc, aes(x = high_use, y = absences, col = sex)) + geom_boxplot() + ggtitle("Student absences by alcohol consumption and sex")
g1
